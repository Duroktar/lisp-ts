...
// import { MalformedStringError, MissingParenthesisError, UnexpectedParenthesisError, InvalidCharacterError } from "./error";
...
//       if (close()) { advance(); }
//       else
//         throw new MissingParenthesisError(startIdx, currentIdx);
...
//           return new Character(Symbol.for(char))
//         }
...
//         advance();
//       else
//         throw new MalformedStringError(openIdx, lastOpenIdx);
